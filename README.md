...
## Key features
- Calorie estimates for popular Indian foods
- Workout-aware insights that factor sets, reps, and daily steps
- Maintenance-calorie estimation with clear bulk/cut guidance
- Simple user interface focused on rapid daily check-ins
- End-of-day fitness summary cards
- Micro-coach nudges that react to steps, meals, and calorie balance
- Smart portion presets for Indian staples with quick multipliers
